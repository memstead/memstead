...
| `INVALID_VERDICT` | CLI, MCP | `crates/memstead-cli/src/commands/check.rs:41`<br>`crates/memstead-mcp/src/filesystem_server.rs:2270`<br>`crates/memstead-mcp/src/server.rs:3344` |
