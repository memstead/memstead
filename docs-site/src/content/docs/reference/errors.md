...
| `CONSTRAINT_UNSATISFIED` | engine | `crates/memstead-base/src/engine/error.rs:1324`<br>`crates/memstead-base/src/engine/outcomes.rs:643`<br>`crates/memstead-base/src/ops/mod.rs:1997` |
...
| `DESCRIPTION_NOT_PERMITTED` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1397`<br>`crates/memstead-base/src/ops/mod.rs:2023`<br>`crates/memstead-mcp/src/filesystem_server.rs:962`<br>`crates/memstead-mcp/src/server.rs:1597` |
...
| `MISSING_REQUIRED_DESCRIPTION` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1396`<br>`crates/memstead-base/src/ops/mod.rs:2022`<br>`crates/memstead-mcp/src/filesystem_server.rs:949`<br>`crates/memstead-mcp/src/server.rs:1614` |
| `MISSING_REQUIRED_FIELD` | engine | `crates/memstead-base/src/ops/mod.rs:1944` |
| `MISSING_REQUIRED_OUTGOING` | engine | `crates/memstead-base/src/engine/error.rs:1325`<br>`crates/memstead-base/src/engine/outcomes.rs:642`<br>`crates/memstead-base/src/ops/mod.rs:1995` |
| `MISSING_REQUIRED_SECTION` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1370`<br>`crates/memstead-base/src/engine/outcomes.rs:636`<br>`crates/memstead-base/src/ops/mod.rs:1943`<br>`crates/memstead-mcp/src/filesystem_server.rs:896`<br>`crates/memstead-mcp/src/server.rs:1289` |
