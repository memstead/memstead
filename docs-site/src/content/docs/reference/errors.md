...
| `ANCHORS_SIDECAR_UNREADABLE` | CLI | `crates/memstead-cli/src/commands/projection.rs:2073` |
...
| `BATCH_REFUSED` | CLI, MCP | `crates/memstead-cli/src/commands/batch.rs:117`<br>`crates/memstead-mcp/src/server.rs:3065` |
...
| `CHANGELOG_ERROR` | MCP | `crates/memstead-mcp/src/filesystem_server.rs:2054` |
...
| `INTERNAL` | CLI, MCP | `crates/memstead-cli/src/lib.rs:28`<br>`crates/memstead-mcp/src/filesystem_server.rs:1819`<br>`crates/memstead-mcp/src/filesystem_server.rs:1884` |
...
| `INVALID_VERDICT` | CLI, MCP | `crates/memstead-cli/src/commands/check.rs:41`<br>`crates/memstead-mcp/src/server.rs:3282` |
...
| `NO_ACTIVE_BINDING` | CLI | `crates/memstead-cli/src/commands/projection.rs:1644` |
...
| `PROJECTION_ADVANCE_FAILED` | CLI | `crates/memstead-cli/src/commands/projection.rs:1725`<br>`crates/memstead-cli/src/commands/projection.rs:1770`<br>`crates/memstead-cli/src/commands/projection.rs:1805` |
| `PROJECTION_ADVANCE_UNKNOWN_ARTIFACT` | CLI | `crates/memstead-cli/src/commands/projection.rs:1760` |
| `PROJECTION_BRIEF_BINDING_REQUIRED` | CLI | `crates/memstead-cli/src/commands/projection.rs:629` |
| `PROJECTION_BUILD_NOT_ENABLED` | CLI | `crates/memstead-cli/src/commands/projection.rs:569` |
| `PROJECTION_CAPABILITY_UNSUPPORTED` | CLI | `crates/memstead-cli/src/commands/projection.rs:532`<br>`crates/memstead-cli/src/commands/projection.rs:1557`<br>`crates/memstead-cli/src/commands/projection.rs:2123` |
| `PROJECTION_ENABLE_FAILED` | CLI | `crates/memstead-cli/src/commands/projection.rs:1425` |
| `PROJECTION_EXCLUDE_FAILED` | CLI | `crates/memstead-cli/src/commands/projection.rs:1902`<br>`crates/memstead-cli/src/commands/projection.rs:1936` |
| `PROJECTION_EXCLUDE_NOT_SOURCE_MEMBER` | CLI | `crates/memstead-cli/src/commands/projection.rs:1897` |
| `PROJECTION_EXISTS` | CLI | `crates/memstead-cli/src/commands/projection.rs:862` |
| `PROJECTION_FINDINGS_READ_FAILED` | CLI | `crates/memstead-cli/src/commands/projection.rs:575` |
| `PROJECTION_INIT_FAILED` | CLI | `crates/memstead-cli/src/commands/projection.rs:811`<br>`crates/memstead-cli/src/commands/quickstart.rs:596` |
| `PROJECTION_INVALID_DISPOSITIONS` | CLI | `crates/memstead-cli/src/commands/projection.rs:1791` |
| `PROJECTION_INVALID_EXCLUSIONS` | CLI | `crates/memstead-cli/src/commands/projection.rs:1923` |
| `PROJECTION_INVALID_NAME` | CLI | `crates/memstead-cli/src/commands/projection.rs:583`<br>`crates/memstead-cli/src/commands/projection.rs:836`<br>`crates/memstead-cli/src/commands/projection.rs:1408`<br>`crates/memstead-cli/src/commands/projection.rs:1718`<br>`crates/memstead-cli/src/commands/projection.rs:1738`<br>`crates/memstead-cli/src/commands/projection.rs:1892` |
| `PROJECTION_LOAD_FAILED` | CLI | `crates/memstead-cli/src/commands/projection.rs:563`<br>`crates/memstead-cli/src/commands/projection.rs:646`<br>`crates/memstead-cli/src/commands/projection.rs:692`<br>`crates/memstead-cli/src/commands/projection.rs:1654` |
| `PROJECTION_MIGRATE_DANGLING_REF` | CLI | `crates/memstead-cli/src/commands/projection.rs:973` |
| `PROJECTION_MIGRATE_FAILED` | CLI | `crates/memstead-cli/src/commands/projection.rs:999`<br>`crates/memstead-cli/src/commands/projection.rs:1190`<br>`crates/memstead-cli/src/commands/projection.rs:1302`<br>`crates/memstead-cli/src/commands/projection.rs:1311`<br>`crates/memstead-cli/src/commands/projection.rs:1321` |
| `PROJECTION_MIGRATE_INERT_PROJECTION` | CLI | `crates/memstead-cli/src/commands/projection.rs:1242` |
| `PROJECTION_MIGRATE_MALFORMED_REF` | CLI | `crates/memstead-cli/src/commands/projection.rs:966` |
| `PROJECTION_MIGRATE_ORPHAN_RECORDS` | CLI | `crates/memstead-cli/src/commands/projection.rs:978` |
| `PROJECTION_MIGRATE_REFINEMENT` | CLI | `crates/memstead-cli/src/commands/projection.rs:961` |
| `PROJECTION_NOT_FOUND` | CLI | `crates/memstead-cli/src/commands/projection.rs:580`<br>`crates/memstead-cli/src/commands/projection.rs:1083`<br>`crates/memstead-cli/src/commands/projection.rs:1463` |
| `PROJECTION_OP_ALREADY_ENABLED` | CLI | `crates/memstead-cli/src/commands/projection.rs:1498` |
| `PROJECTION_QUARANTINED` | CLI | `crates/memstead-cli/src/commands/projection.rs:1067` |
| `PROJECTION_SCOPE_UNINTERPRETABLE` | CLI | `crates/memstead-cli/src/commands/projection.rs:590`<br>`crates/memstead-cli/src/commands/projection.rs:1722` |
| `PROJECTION_STORE_LEGACY` | engine | `crates/memstead-base/src/workspace_store.rs:162` |
| `PROJECTION_SYNC_NOT_ENABLED` | CLI | `crates/memstead-cli/src/commands/projection.rs:542` |
| `PROJECTION_VERIFY_BACKFILL_FAILED` | CLI | `crates/memstead-cli/src/commands/projection.rs:2257` |
| `PROJECTION_VERIFY_BASELINE_FAILED` | CLI | `crates/memstead-cli/src/commands/projection.rs:2269` |
| `PROJECTION_VERIFY_FAILED` | CLI | `crates/memstead-cli/src/commands/projection.rs:2043`<br>`crates/memstead-cli/src/commands/projection.rs:2134` |
| `PROJECTION_VERIFY_FINDINGS` | CLI | `crates/memstead-cli/src/commands/projection.rs:2290` |
...
| `SCHEMA_NOT_FOUND` | engine, CLI, MCP | `crates/memstead-base/src/engine/error.rs:1248`<br>`crates/memstead-cli/src/commands/schema.rs:166`<br>`crates/memstead-cli/src/commands/schema.rs:215`<br>`crates/memstead-cli/src/commands/schema.rs:982`<br>`crates/memstead-cli/src/commands/schema.rs:1016`<br>`crates/memstead-cli/src/commands/schema.rs:1032`<br>`crates/memstead-mcp/src/server.rs:1403` |
...
| `SCHEMA_VALIDATION_FAILED` | engine, CLI, MCP | `crates/memstead-base/src/engine/error.rs:1250`<br>`crates/memstead-cli/src/commands/schema.rs:733`<br>`crates/memstead-cli/src/commands/schema.rs:761`<br>`crates/memstead-cli/src/commands/schema.rs:786`<br>`crates/memstead-cli/src/commands/schema.rs:931`<br>`crates/memstead-cli/src/commands/schema.rs:943`<br>`crates/memstead-mcp/src/server.rs:1421` |
...
| `SOURCE_UNREACHABLE` | CLI | `crates/memstead-cli/src/commands/projection.rs:2102` |
...
| `UNKNOWN_ENTITY_TYPE` | engine, CLI, MCP | `crates/memstead-base/src/engine/error.rs:1209`<br>`crates/memstead-cli/src/commands/type_cmd.rs:54`<br>`crates/memstead-mcp/src/filesystem_server.rs:309`<br>`crates/memstead-mcp/src/server.rs:958`<br>`crates/memstead-mcp/src/server.rs:2604` |
...
| `WORKSPACE_NOT_INITIALISED` | engine, CLI | `crates/memstead-base/src/engine/error.rs:2165`<br>`crates/memstead-base/src/workspace_store.rs:157`<br>`crates/memstead-cli/src/commands/changes.rs:246`<br>`crates/memstead-cli/src/commands/publish.rs:488`<br>`crates/memstead-cli/src/setup.rs:41` |
