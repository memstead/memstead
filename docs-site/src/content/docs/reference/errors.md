...
| `BRANCH_RESET_HEAD_MOVED` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1000`<br>`crates/memstead-mcp/src/server.rs:779` |
...
| `CONFLICTING_SECTION_MODES` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1027`<br>`crates/memstead-mcp/src/server.rs:1011` |
| `CONTEXT_NOT_COMPUTABLE` | CLI | `crates/memstead-cli/src/commands/context.rs:54` |
| `CROSS_MEM_EDGE_NOT_DECLARED` | engine | `crates/memstead-base/src/engine/error.rs:1011` |
| `CROSS_MEM_LINK_NOT_ALLOWED` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1009`<br>`crates/memstead-mcp/src/filesystem_server.rs:437` |
| `CROSS_MEM_TARGET_MEM_UNCREATED` | engine | `crates/memstead-base/src/ops/mod.rs:1350` |
| `CROSS_MEM_TARGET_NOT_FOUND` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1010`<br>`crates/memstead-mcp/src/filesystem_server.rs:446` |
| `DESCRIPTION_NOT_PERMITTED` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1047`<br>`crates/memstead-base/src/ops/mod.rs:1414`<br>`crates/memstead-mcp/src/server.rs:1403` |
...
| `DUPLICATE_MEM` | engine, MCP | `crates/memstead-base/src/engine/error.rs:991`<br>`crates/memstead-mcp/src/server.rs:1508` |
...
| `EMPTY_UPDATE` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1014`<br>`crates/memstead-mcp/src/server.rs:1576` |
| `ENGINE_LOCK_POISONED` | MCP | `crates/memstead-mcp/src/error_envelopes.rs:70` |
| `ENTITY_ALREADY_EXISTS` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1004`<br>`crates/memstead-mcp/src/filesystem_server.rs:344`<br>`crates/memstead-mcp/src/server.rs:725` |
| `ENTITY_NOT_FOUND` | engine, CLI, MCP | `crates/memstead-base/src/engine/error.rs:1005`<br>`crates/memstead-cli/src/commands/context.rs:60`<br>`crates/memstead-cli/src/commands/delete.rs:55`<br>`crates/memstead-cli/src/commands/delete.rs:84`<br>`crates/memstead-cli/src/commands/delete.rs:127`<br>`crates/memstead-cli/src/commands/delete.rs:151`<br>`crates/memstead-cli/src/commands/entity.rs:45`<br>`crates/memstead-cli/src/commands/relations.rs:72`<br>`crates/memstead-cli/src/commands/rename.rs:139`<br>`crates/memstead-cli/src/commands/rename.rs:173`<br>`crates/memstead-cli/src/commands/update.rs:528`<br>`crates/memstead-cli/src/commands/update.rs:551`<br>`crates/memstead-mcp/src/filesystem_server.rs:348`<br>`crates/memstead-mcp/src/filesystem_server.rs:996`<br>`crates/memstead-mcp/src/filesystem_server.rs:1546`<br>`crates/memstead-mcp/src/server.rs:715`<br>`crates/memstead-mcp/src/server.rs:1776`<br>`crates/memstead-mcp/src/server.rs:2272` |
...
| `HASH_MISMATCH` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1006`<br>`crates/memstead-mcp/src/server.rs:738` |
| `HAS_INCOMING_REFS` | engine | `crates/memstead-base/src/engine/error.rs:1007` |
...
| `INVALID_CURSOR` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1044`<br>`crates/memstead-mcp/src/server.rs:1591` |
| `INVALID_DOMAIN` | CLI | `crates/memstead-cli/src/commands/domain.rs:148` |
| `INVALID_ENTITY_ID` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1024`<br>`crates/memstead-mcp/src/server.rs:270`<br>`crates/memstead-mcp/src/server.rs:285`<br>`crates/memstead-mcp/src/server.rs:1233` |
...
| `INVALID_TITLE` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1003`<br>`crates/memstead-mcp/src/server.rs:1200` |
| `INVALID_VERSION` | CLI | `crates/memstead-cli/src/commands/publish.rs:123` |
| `INVALID_WIKI_LINK_TARGET` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1025`<br>`crates/memstead-mcp/src/server.rs:1248` |
...
| `LOCAL_DIVERGENCE` | engine, MCP | `crates/memstead-base/src/engine/error.rs:995`<br>`crates/memstead-mcp/src/server.rs:818` |
| `LOCAL_INVALID_STATE` | engine, MCP | `crates/memstead-base/src/engine/error.rs:997`<br>`crates/memstead-mcp/src/server.rs:840` |
| `LOGIN_FAILED` | CLI | `crates/memstead-cli/src/commands/login.rs:40`<br>`crates/memstead-cli/src/commands/publish.rs:461` |
| `MARKDOWN_EXPORT_UNSUPPORTED_BACKEND` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1053`<br>`crates/memstead-mcp/src/server.rs:1563` |
| `MEM_CONFIG_INCOMPLETE` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1045`<br>`crates/memstead-mcp/src/server.rs:1374` |
| `MEM_ERROR` | engine, CLI, MCP | `crates/memstead-base/src/engine/error.rs:1037`<br>`crates/memstead-base/src/engine/error.rs:1040`<br>`crates/memstead-cli/src/commands/workspace.rs:761`<br>`crates/memstead-cli/src/commands/workspace.rs:768`<br>`crates/memstead-mcp/src/filesystem_server.rs:813`<br>`crates/memstead-mcp/src/server.rs:1336`<br>`crates/memstead-mcp/src/server.rs:1538` |
| `MEM_FILES_NOT_DELETED` | engine | `crates/memstead-base/src/ops/mod.rs:1410` |
| `MEM_HAS_INCOMING_REFS` | engine | `crates/memstead-base/src/engine/error.rs:1008` |
| `MEM_NAME_COLLISION` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1041`<br>`crates/memstead-mcp/src/server.rs:1306` |
...
| `MISSING_REQUIRED_DESCRIPTION` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1046`<br>`crates/memstead-base/src/ops/mod.rs:1413`<br>`crates/memstead-mcp/src/server.rs:1420` |
...
| `MISSING_REQUIRED_SECTION` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1031`<br>`crates/memstead-base/src/ops/mod.rs:1351`<br>`crates/memstead-mcp/src/server.rs:1105` |
...
| `NON_FAST_FORWARD` | engine, MCP | `crates/memstead-base/src/engine/error.rs:996`<br>`crates/memstead-mcp/src/server.rs:827` |
...
| `PARSE_ERROR` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1035`<br>`crates/memstead-base/src/engine/error.rs:1036`<br>`crates/memstead-mcp/src/filesystem_server.rs:815`<br>`crates/memstead-mcp/src/filesystem_server.rs:817`<br>`crates/memstead-mcp/src/server.rs:1520`<br>`crates/memstead-mcp/src/server.rs:1529` |
| `PATCH_OLD_NOT_FOUND` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1033`<br>`crates/memstead-mcp/src/server.rs:1142` |
| `PATCH_SECTION_EMPTY` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1032`<br>`crates/memstead-mcp/src/filesystem_server.rs:789`<br>`crates/memstead-mcp/src/server.rs:1129` |
| `PROJECTION_ADVANCE_FAILED` | CLI | `crates/memstead-cli/src/commands/projection.rs:1075`<br>`crates/memstead-cli/src/commands/projection.rs:1098`<br>`crates/memstead-cli/src/commands/projection.rs:1132` |
| `PROJECTION_ADVANCE_UNKNOWN_ARTIFACT` | CLI | `crates/memstead-cli/src/commands/projection.rs:1093` |
| `PROJECTION_BUILD_NOT_ENABLED` | CLI | `crates/memstead-cli/src/commands/projection.rs:258` |
| `PROJECTION_CAPABILITY_UNSUPPORTED` | CLI | `crates/memstead-cli/src/commands/projection.rs:1023` |
| `PROJECTION_ENABLE_FAILED` | CLI | `crates/memstead-cli/src/commands/projection.rs:895`<br>`crates/memstead-cli/src/commands/projection.rs:1008` |
| `PROJECTION_EXISTS` | CLI | `crates/memstead-cli/src/commands/projection.rs:417` |
| `PROJECTION_FACET_NOT_FOUND` | CLI | `crates/memstead-cli/src/commands/projection.rs:266`<br>`crates/memstead-cli/src/commands/projection.rs:1067` |
| `PROJECTION_INIT_FAILED` | CLI | `crates/memstead-cli/src/commands/projection.rs:366` |
| `PROJECTION_INVALID_DISPOSITIONS` | CLI | `crates/memstead-cli/src/commands/projection.rs:1119` |
| `PROJECTION_INVALID_NAME` | CLI | `crates/memstead-cli/src/commands/projection.rs:272`<br>`crates/memstead-cli/src/commands/projection.rs:391`<br>`crates/memstead-cli/src/commands/projection.rs:878`<br>`crates/memstead-cli/src/commands/projection.rs:1073`<br>`crates/memstead-cli/src/commands/projection.rs:1088` |
| `PROJECTION_LOAD_FAILED` | CLI | `crates/memstead-cli/src/commands/projection.rs:252`<br>`crates/memstead-cli/src/commands/projection.rs:302` |
| `PROJECTION_MEDIUM_NOT_FOUND` | CLI | `crates/memstead-cli/src/commands/projection.rs:269`<br>`crates/memstead-cli/src/commands/projection.rs:1070` |
| `PROJECTION_MIGRATE_DANGLING_REF` | CLI | `crates/memstead-cli/src/commands/projection.rs:573` |
| `PROJECTION_MIGRATE_FAILED` | CLI | `crates/memstead-cli/src/commands/projection.rs:594`<br>`crates/memstead-cli/src/commands/projection.rs:731`<br>`crates/memstead-cli/src/commands/projection.rs:788`<br>`crates/memstead-cli/src/commands/projection.rs:796` |
| `PROJECTION_MIGRATE_MALFORMED_REF` | CLI | `crates/memstead-cli/src/commands/projection.rs:568` |
| `PROJECTION_MIGRATE_REFINEMENT` | CLI | `crates/memstead-cli/src/commands/projection.rs:563` |
| `PROJECTION_NOT_FOUND` | CLI | `crates/memstead-cli/src/commands/projection.rs:263`<br>`crates/memstead-cli/src/commands/projection.rs:933`<br>`crates/memstead-cli/src/commands/projection.rs:1144` |
| `PROJECTION_OP_ALREADY_ENABLED` | CLI | `crates/memstead-cli/src/commands/projection.rs:957` |
| `PROJECTION_SYNC_NOT_ENABLED` | CLI | `crates/memstead-cli/src/commands/projection.rs:1159` |
| `PUSHED_COMMITS_PROTECTED` | engine, MCP | `crates/memstead-base/src/engine/error.rs:999`<br>`crates/memstead-mcp/src/server.rs:796` |
...
| `READ_ONLY_MOUNT` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1001`<br>`crates/memstead-mcp/src/server.rs:870` |
...
| `RELATIONSHIP_CYCLE` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1028`<br>`crates/memstead-mcp/src/server.rs:1029` |
| `RELATION_HAS_BODY_LINKS` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1019`<br>`crates/memstead-mcp/src/server.rs:1285` |
| `RELATION_MANUAL_AUTHORING_FORBIDDEN` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1049`<br>`crates/memstead-mcp/src/server.rs:1438` |
| `RENAME_BLOCKED_BY_CROSS_MEM_POLICY` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1016`<br>`crates/memstead-mcp/src/server.rs:1478` |
| `RENAME_NO_OP` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1013`<br>`crates/memstead-mcp/src/filesystem_server.rs:488`<br>`crates/memstead-mcp/src/server.rs:1452` |
| `RENAME_PARTIAL_FAILURE` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1018`<br>`crates/memstead-mcp/src/server.rs:1495` |
| `REPAIR_NOT_NEEDED` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1012`<br>`crates/memstead-mcp/src/server.rs:1002` |
| `REQUIRED_FIELD_UNSET` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1030`<br>`crates/memstead-mcp/src/server.rs:1071` |
| `RESIDUAL_STUB_FOR_READONLY_REFERRERS` | engine | `crates/memstead-base/src/ops/mod.rs:1409` |
| `SCHEMA_NOT_FOUND` | engine, CLI, MCP | `crates/memstead-base/src/engine/error.rs:1038`<br>`crates/memstead-cli/src/commands/schema.rs:687`<br>`crates/memstead-cli/src/commands/schema.rs:721`<br>`crates/memstead-cli/src/commands/schema.rs:737`<br>`crates/memstead-mcp/src/server.rs:1318` |
...
| `SCHEMA_RESOLVER_INIT_FAILED` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1039`<br>`crates/memstead-mcp/src/server.rs:1327` |
...
| `SCHEMA_VIOLATION_IN_FETCH` | engine, MCP | `crates/memstead-base/src/engine/error.rs:998`<br>`crates/memstead-mcp/src/server.rs:857` |
...
| `SEARCH_UNAVAILABLE_IN_WASM` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1051`<br>`crates/memstead-mcp/src/server.rs:1547` |
...
| `SET_AND_UNSET_CONFLICT` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1029`<br>`crates/memstead-mcp/src/server.rs:1120` |
| `STUB_CANNOT_RELATE` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1021`<br>`crates/memstead-mcp/src/server.rs:1206` |
| `STUB_FILTER_EXCLUDES_ALL` | engine | `crates/memstead-base/src/ops/mod.rs:1360` |
| `STUB_NOT_RENAMABLE` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1023`<br>`crates/memstead-mcp/src/server.rs:1224` |
| `STUB_NOT_UPDATABLE` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1022`<br>`crates/memstead-mcp/src/server.rs:1215` |
...
| `UNKNOWN_ENTITY_TYPE` | engine, CLI, MCP | `crates/memstead-base/src/engine/error.rs:1002`<br>`crates/memstead-cli/src/commands/type_cmd.rs:54`<br>`crates/memstead-mcp/src/filesystem_server.rs:284`<br>`crates/memstead-mcp/src/server.rs:884` |
...
| `UNKNOWN_REF` | engine, MCP | `crates/memstead-base/src/engine/error.rs:993`<br>`crates/memstead-mcp/src/server.rs:766` |
| `UNKNOWN_REMOTE` | engine, MCP | `crates/memstead-base/src/engine/error.rs:994`<br>`crates/memstead-mcp/src/server.rs:809` |
...
| `WIKILINK_WITHOUT_RELATION` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1020`<br>`crates/memstead-mcp/src/server.rs:1387` |
