...
| `BATCH_REFUSED` | CLI, MCP | `crates/memstead-cli/src/commands/batch.rs:117`<br>`crates/memstead-mcp/src/filesystem_server.rs:1666`<br>`crates/memstead-mcp/src/server.rs:3197` |
...
| `CHANGELOG_ERROR` | MCP | `crates/memstead-mcp/src/filesystem_server.rs:2205` |
...
| `CONSTRAINT_UNSATISFIED` | engine | `crates/memstead-base/src/engine/error.rs:1283`<br>`crates/memstead-base/src/ops/mod.rs:1994` |
...
| `DESCRIPTION_NOT_PERMITTED` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1339`<br>`crates/memstead-base/src/ops/mod.rs:2020`<br>`crates/memstead-mcp/src/filesystem_server.rs:956`<br>`crates/memstead-mcp/src/server.rs:1597` |
...
| `EXPECTED_HASH_REQUIRED` | MCP | `crates/memstead-mcp/src/filesystem_server.rs:1424`<br>`crates/memstead-mcp/src/server.rs:2940` |
...
| `INTERNAL` | CLI, MCP | `crates/memstead-cli/src/lib.rs:29`<br>`crates/memstead-mcp/src/filesystem_server.rs:1942`<br>`crates/memstead-mcp/src/filesystem_server.rs:2005`<br>`crates/memstead-mcp/src/filesystem_server.rs:2035` |
...
| `INVALID_CHECK_KIND` | CLI, MCP | `crates/memstead-cli/src/commands/check.rs:65`<br>`crates/memstead-mcp/src/filesystem_server.rs:2367`<br>`crates/memstead-mcp/src/server.rs:3438` |
| `INVALID_CURSOR` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1334`<br>`crates/memstead-base/src/engine/error.rs:1335`<br>`crates/memstead-mcp/src/filesystem_server.rs:1075`<br>`crates/memstead-mcp/src/filesystem_server.rs:2230`<br>`crates/memstead-mcp/src/server.rs:1785` |
...
| `INVALID_VERDICT` | CLI, MCP | `crates/memstead-cli/src/commands/check.rs:51`<br>`crates/memstead-mcp/src/filesystem_server.rs:2352`<br>`crates/memstead-mcp/src/server.rs:3419` |
...
| `MISSING_REQUIRED_DESCRIPTION` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1338`<br>`crates/memstead-base/src/ops/mod.rs:2019`<br>`crates/memstead-mcp/src/filesystem_server.rs:943`<br>`crates/memstead-mcp/src/server.rs:1614` |
| `MISSING_REQUIRED_FIELD` | engine | `crates/memstead-base/src/ops/mod.rs:1941` |
| `MISSING_REQUIRED_OUTGOING` | engine | `crates/memstead-base/src/engine/error.rs:1284`<br>`crates/memstead-base/src/ops/mod.rs:1992` |
| `MISSING_REQUIRED_SECTION` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1312`<br>`crates/memstead-base/src/ops/mod.rs:1940`<br>`crates/memstead-mcp/src/filesystem_server.rs:890`<br>`crates/memstead-mcp/src/server.rs:1289` |
