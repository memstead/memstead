...
| `CONSTRAINT_UNSATISFIED` | engine | `crates/memstead-base/src/engine/error.rs:1212`<br>`crates/memstead-base/src/ops/mod.rs:1809` |
...
| `DESCRIPTION_NOT_PERMITTED` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1264`<br>`crates/memstead-base/src/ops/mod.rs:1831`<br>`crates/memstead-mcp/src/server.rs:1519` |
...
| `IO_ERROR` | CLI | `crates/memstead-cli/src/commands/export.rs:569`<br>`crates/memstead-cli/src/commands/export.rs:683`<br>`crates/memstead-cli/src/commands/schema.rs:161`<br>`crates/memstead-cli/src/commands/schema.rs:170`<br>`crates/memstead-cli/src/commands/schema.rs:195`<br>`crates/memstead-cli/src/commands/schema.rs:207`<br>`crates/memstead-cli/src/commands/schema.rs:1006`<br>`crates/memstead-cli/src/commands/schema.rs:1015` |
...
| `MEM_REPO_NOT_SUPPORTED` | CLI | `crates/memstead-cli/src/commands/schema.rs:788` |
...
| `MISSING_REQUIRED_DESCRIPTION` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1263`<br>`crates/memstead-base/src/ops/mod.rs:1830`<br>`crates/memstead-mcp/src/server.rs:1536` |
| `MISSING_REQUIRED_FIELD` | engine | `crates/memstead-base/src/ops/mod.rs:1756` |
| `MISSING_REQUIRED_OUTGOING` | engine | `crates/memstead-base/src/engine/error.rs:1213`<br>`crates/memstead-base/src/ops/mod.rs:1807` |
| `MISSING_REQUIRED_SECTION` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1241`<br>`crates/memstead-base/src/ops/mod.rs:1755`<br>`crates/memstead-mcp/src/server.rs:1213` |
...
| `NO_WORKSPACE` | CLI | `crates/memstead-cli/src/commands/schema.rs:686` |
...
| `SCHEMA_NOT_FOUND` | engine, CLI, MCP | `crates/memstead-base/src/engine/error.rs:1248`<br>`crates/memstead-cli/src/commands/schema.rs:867`<br>`crates/memstead-cli/src/commands/schema.rs:901`<br>`crates/memstead-cli/src/commands/schema.rs:917`<br>`crates/memstead-mcp/src/server.rs:1403` |
...
| `SCHEMA_VALIDATION_FAILED` | engine, CLI, MCP | `crates/memstead-base/src/engine/error.rs:1250`<br>`crates/memstead-cli/src/commands/schema.rs:618`<br>`crates/memstead-cli/src/commands/schema.rs:646`<br>`crates/memstead-cli/src/commands/schema.rs:671`<br>`crates/memstead-cli/src/commands/schema.rs:816`<br>`crates/memstead-cli/src/commands/schema.rs:828`<br>`crates/memstead-mcp/src/server.rs:1421` |
