...
| `ANCHORS_SIDECAR_UNREADABLE` | CLI | `crates/memstead-cli/src/commands/anchors.rs:67`<br>`crates/memstead-cli/src/commands/projection.rs:2422`<br>`crates/memstead-cli/src/commands/verify_anchors.rs:154` |
...
| `MEM_QUARANTINED` | engine, CLI, MCP | `crates/memstead-base/src/engine/error.rs:1335`<br>`crates/memstead-cli/src/commands/projection.rs:778`<br>`crates/memstead-cli/src/commands/projection.rs:2392`<br>`crates/memstead-mcp/src/server.rs:908` |
...
| `NO_ACTIVE_BINDING` | CLI | `crates/memstead-cli/src/commands/projection.rs:1900` |
...
| `PROJECTION_ADVANCE_FAILED` | CLI | `crates/memstead-cli/src/commands/projection.rs:1981`<br>`crates/memstead-cli/src/commands/projection.rs:2026`<br>`crates/memstead-cli/src/commands/projection.rs:2061` |
| `PROJECTION_ADVANCE_UNKNOWN_ARTIFACT` | CLI | `crates/memstead-cli/src/commands/projection.rs:2016` |
...
| `PROJECTION_CAPABILITY_UNSUPPORTED` | CLI | `crates/memstead-cli/src/commands/projection.rs:634`<br>`crates/memstead-cli/src/commands/projection.rs:1695`<br>`crates/memstead-cli/src/commands/projection.rs:2473` |
| `PROJECTION_EDIT_FAILED` | CLI | `crates/memstead-cli/src/commands/projection.rs:1842` |
| `PROJECTION_EDIT_INVALID_JSON` | CLI | `crates/memstead-cli/src/commands/projection.rs:1819` |
| `PROJECTION_EDIT_REFUSED` | CLI | `crates/memstead-cli/src/commands/projection.rs:1825` |
| `PROJECTION_ENABLE_FAILED` | CLI | `crates/memstead-cli/src/commands/projection.rs:1563` |
| `PROJECTION_EXCLUDE_AMBIGUOUS_ARTIFACT` | CLI | `crates/memstead-cli/src/commands/projection.rs:2155` |
| `PROJECTION_EXCLUDE_FAILED` | CLI | `crates/memstead-cli/src/commands/projection.rs:2193`<br>`crates/memstead-cli/src/commands/projection.rs:2227` |
| `PROJECTION_EXCLUDE_NOT_SOURCE_MEMBER` | CLI | `crates/memstead-cli/src/commands/projection.rs:2166` |
| `PROJECTION_EXCLUDE_PARTIAL_ENUMERATION` | CLI | `crates/memstead-cli/src/commands/projection.rs:2188` |
| `PROJECTION_EXISTS` | CLI | `crates/memstead-cli/src/commands/projection.rs:996` |
| `PROJECTION_FINDINGS_READ_FAILED` | CLI | `crates/memstead-cli/src/commands/projection.rs:677` |
| `PROJECTION_INIT_FAILED` | CLI | `crates/memstead-cli/src/commands/projection.rs:945`<br>`crates/memstead-cli/src/commands/quickstart.rs:596` |
| `PROJECTION_INVALID_DISPOSITIONS` | CLI | `crates/memstead-cli/src/commands/projection.rs:2047` |
| `PROJECTION_INVALID_EXCLUSIONS` | CLI | `crates/memstead-cli/src/commands/projection.rs:2214` |
| `PROJECTION_INVALID_NAME` | CLI | `crates/memstead-cli/src/commands/projection.rs:685`<br>`crates/memstead-cli/src/commands/projection.rs:970`<br>`crates/memstead-cli/src/commands/projection.rs:1546`<br>`crates/memstead-cli/src/commands/projection.rs:1974`<br>`crates/memstead-cli/src/commands/projection.rs:1994`<br>`crates/memstead-cli/src/commands/projection.rs:2148` |
| `PROJECTION_LOAD_FAILED` | CLI | `crates/memstead-cli/src/commands/projection.rs:665`<br>`crates/memstead-cli/src/commands/projection.rs:748`<br>`crates/memstead-cli/src/commands/projection.rs:826`<br>`crates/memstead-cli/src/commands/projection.rs:1910` |
| `PROJECTION_MIGRATE_DANGLING_REF` | CLI | `crates/memstead-cli/src/commands/projection.rs:1107` |
| `PROJECTION_MIGRATE_FAILED` | CLI | `crates/memstead-cli/src/commands/projection.rs:1133`<br>`crates/memstead-cli/src/commands/projection.rs:1328`<br>`crates/memstead-cli/src/commands/projection.rs:1440`<br>`crates/memstead-cli/src/commands/projection.rs:1449`<br>`crates/memstead-cli/src/commands/projection.rs:1459` |
| `PROJECTION_MIGRATE_INERT_PROJECTION` | CLI | `crates/memstead-cli/src/commands/projection.rs:1380` |
| `PROJECTION_MIGRATE_MALFORMED_REF` | CLI | `crates/memstead-cli/src/commands/projection.rs:1100` |
| `PROJECTION_MIGRATE_ORPHAN_RECORDS` | CLI | `crates/memstead-cli/src/commands/projection.rs:1112` |
| `PROJECTION_MIGRATE_REFINEMENT` | CLI | `crates/memstead-cli/src/commands/projection.rs:1095` |
| `PROJECTION_NOT_FOUND` | CLI | `crates/memstead-cli/src/commands/projection.rs:682`<br>`crates/memstead-cli/src/commands/projection.rs:1217`<br>`crates/memstead-cli/src/commands/projection.rs:1601`<br>`crates/memstead-cli/src/commands/projection.rs:1810` |
| `PROJECTION_OP_ALREADY_ENABLED` | CLI | `crates/memstead-cli/src/commands/projection.rs:1636` |
| `PROJECTION_QUARANTINED` | CLI | `crates/memstead-cli/src/commands/projection.rs:1201` |
| `PROJECTION_SCOPE_UNINTERPRETABLE` | CLI | `crates/memstead-cli/src/commands/projection.rs:692`<br>`crates/memstead-cli/src/commands/projection.rs:1978` |
...
| `PROJECTION_VERIFY_BACKFILL_FAILED` | CLI | `crates/memstead-cli/src/commands/projection.rs:2647` |
| `PROJECTION_VERIFY_BASELINE_FAILED` | CLI | `crates/memstead-cli/src/commands/projection.rs:2659` |
| `PROJECTION_VERIFY_FAILED` | CLI | `crates/memstead-cli/src/commands/projection.rs:2357`<br>`crates/memstead-cli/src/commands/projection.rs:2484` |
| `PROJECTION_VERIFY_FINDINGS` | CLI | `crates/memstead-cli/src/commands/projection.rs:2680` |
| `PROJECTION_VERIFY_INCONCLUSIVE` | CLI | `crates/memstead-cli/src/commands/projection.rs:2707` |
...
| `SOURCE_UNREACHABLE` | CLI | `crates/memstead-cli/src/commands/projection.rs:2452` |
