...
| `CHANGELOG_ERROR` | MCP | `crates/memstead-mcp/src/filesystem_server.rs:1631` |
...
| `INTERNAL` | CLI, MCP | `crates/memstead-cli/src/commands/schema.rs:613`<br>`crates/memstead-cli/src/lib.rs:28`<br>`crates/memstead-mcp/src/filesystem_server.rs:1506`<br>`crates/memstead-mcp/src/filesystem_server.rs:1791` |
