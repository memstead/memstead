...
| `CHANGELOG_ERROR` | MCP | `crates/memstead-mcp/src/filesystem_server.rs:2218` |
...
| `INTERNAL` | CLI, MCP | `crates/memstead-cli/src/lib.rs:29`<br>`crates/memstead-mcp/src/filesystem_server.rs:1950`<br>`crates/memstead-mcp/src/filesystem_server.rs:2018`<br>`crates/memstead-mcp/src/filesystem_server.rs:2048` |
...
| `INVALID_CHECK_KIND` | CLI, MCP | `crates/memstead-cli/src/commands/check.rs:109`<br>`crates/memstead-mcp/src/filesystem_server.rs:2438`<br>`crates/memstead-mcp/src/server.rs:3484` |
| `INVALID_CURSOR` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1404`<br>`crates/memstead-base/src/engine/error.rs:1405`<br>`crates/memstead-mcp/src/filesystem_server.rs:1082`<br>`crates/memstead-mcp/src/filesystem_server.rs:2243`<br>`crates/memstead-mcp/src/server.rs:1805` |
...
| `INVALID_VERDICT` | CLI, MCP | `crates/memstead-cli/src/commands/check.rs:154`<br>`crates/memstead-mcp/src/filesystem_server.rs:2421`<br>`crates/memstead-mcp/src/server.rs:3463` |
