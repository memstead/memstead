...
| `MEM_REPO_NOT_SUPPORTED` | CLI | `crates/memstead-cli/src/commands/schema.rs:684` |
...
| `NO_WORKSPACE` | CLI | `crates/memstead-cli/src/commands/schema.rs:586` |
| `NO_WRITABLE_MEM` | CLI | `crates/memstead-cli/src/commands/batch_create.rs:179`<br>`crates/memstead-cli/src/commands/changes.rs:65`<br>`crates/memstead-cli/src/commands/create.rs:504`<br>`crates/memstead-cli/src/commands/export.rs:334` |
...
| `SCHEMA_NOT_FOUND` | engine, CLI, MCP | `crates/memstead-base/src/engine/error.rs:1187`<br>`crates/memstead-cli/src/commands/schema.rs:756`<br>`crates/memstead-cli/src/commands/schema.rs:790`<br>`crates/memstead-cli/src/commands/schema.rs:806`<br>`crates/memstead-mcp/src/server.rs:1379` |
...
| `SCHEMA_VALIDATION_FAILED` | engine, CLI, MCP | `crates/memstead-base/src/engine/error.rs:1188`<br>`crates/memstead-cli/src/commands/schema.rs:546`<br>`crates/memstead-cli/src/commands/schema.rs:571`<br>`crates/memstead-cli/src/commands/schema.rs:712`<br>`crates/memstead-cli/src/commands/schema.rs:724`<br>`crates/memstead-mcp/src/server.rs:1388` |
