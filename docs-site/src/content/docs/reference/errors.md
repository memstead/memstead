...
|------|----------|------------------|
| `AMBIGUOUS_DESCRIPTION_DELIMITER` | engine | `crates/memstead-base/src/ops/mod.rs:1464` |
| `ARCHIVE_ASSEMBLY_FAILED` | CLI | `crates/memstead-cli/src/commands/export.rs:287` |
| `ARCHIVE_READ_FAILED` | CLI | `crates/memstead-cli/src/commands/publish.rs:279` |
| `ARCHIVE_VALIDATION_FAILED` | CLI | `crates/memstead-cli/src/lib.rs:54` |
| `AUTO_STUB_CREATED` | engine | `crates/memstead-base/src/ops/mod.rs:1456` |
...
| `CROSS_VAULT_EDGE_NOT_DECLARED` | engine | `crates/memstead-base/src/engine/error.rs:999` |
| `CROSS_VAULT_LINK_NOT_ALLOWED` | engine | `crates/memstead-base/src/engine/error.rs:997` |
| `CROSS_VAULT_TARGET_NOT_FOUND` | engine | `crates/memstead-base/src/engine/error.rs:998` |
| `CROSS_VAULT_TARGET_VAULT_UNCREATED` | engine | `crates/memstead-base/src/ops/mod.rs:1405` |
| `DESCRIPTION_NOT_PERMITTED` | engine | `crates/memstead-base/src/engine/error.rs:1035`<br>`crates/memstead-base/src/ops/mod.rs:1466` |
| `DOMAIN_KEYGEN_FAILED` | CLI | `crates/memstead-cli/src/commands/domain.rs:73` |
| `DOMAIN_KEY_NOT_FOUND` | CLI | `crates/memstead-cli/src/commands/domain.rs:81`<br>`crates/memstead-cli/src/commands/publish.rs:297` |
| `DUPLICATE_RELATIONSHIP` | engine | `crates/memstead-base/src/ops/mod.rs:1409` |
| `DUPLICATE_SECTION_HEADING` | engine | `crates/memstead-base/src/ops/mod.rs:1452` |
| `DUPLICATE_VAULT` | engine | `crates/memstead-base/src/engine/error.rs:980` |
...
| `FIELD_NOT_FILTERABLE` | engine | `crates/memstead-base/src/ops/mod.rs:1431` |
| `FIELD_NOT_RANGE_FILTERABLE` | engine | `crates/memstead-base/src/ops/mod.rs:1444` |
| `FILTER_TYPE_SCOPED` | engine | `crates/memstead-base/src/ops/mod.rs:1428` |
| `FILTER_VALUE_MULTI_MEMBER` | engine | `crates/memstead-base/src/ops/mod.rs:1432` |
...
| `IGNORED_READONLY_FIELD` | engine | `crates/memstead-base/src/ops/mod.rs:1449` |
| `INLINE_WIKI_LINK_AUTO_STUBBED` | engine | `crates/memstead-base/src/ops/mod.rs:1404` |
...
| `INVALID_ENUM_VALUE` | engine | `crates/memstead-base/src/ops/mod.rs:1433`<br>`crates/memstead-base/src/runtime_validator.rs:197` |
...
| `INVALID_VAULT_NAME` | engine | `crates/memstead-base/src/engine/error.rs:1014` |
| `INVALID_WIKI_LINK_TARGET` | engine | `crates/memstead-base/src/engine/error.rs:1013` |
| `LEGACY_ARCHIVE_FORMAT` | engine | `crates/memstead-base/src/ops/mod.rs:1454` |
| `LIMIT_CLAMPED` | engine | `crates/memstead-base/src/ops/mod.rs:1412` |
...
| `MISSING_REQUIRED_DESCRIPTION` | engine | `crates/memstead-base/src/engine/error.rs:1034`<br>`crates/memstead-base/src/ops/mod.rs:1465` |
| `MISSING_REQUIRED_FIELD` | engine | `crates/memstead-base/src/ops/mod.rs:1407` |
| `MISSING_REQUIRED_OUTGOING` | engine | `crates/memstead-base/src/ops/mod.rs:1451` |
| `MISSING_REQUIRED_SECTION` | engine | `crates/memstead-base/src/engine/error.rs:1019`<br>`crates/memstead-base/src/ops/mod.rs:1406` |
| `NEIGHBOURHOOD_CAPPED` | engine | `crates/memstead-base/src/ops/mod.rs:1434` |
...
| `NOTE_MISSING` | engine | `crates/memstead-base/src/ops/mod.rs:1448` |
| `NO_SUCH_RELATIONSHIP` | engine | `crates/memstead-base/src/ops/mod.rs:1410` |
| `OUTER_REPO_NOT_IGNORING_VAULT_REPO` | engine | `crates/memstead-base/src/ops/mod.rs:1450` |
| `PARSED_RELATION_INVALID` | engine | `crates/memstead-base/src/ops/mod.rs:1458` |
...
| `RANGE_FILTER_KEY_MALFORMED` | engine | `crates/memstead-base/src/ops/mod.rs:1436` |
| `RANGE_FILTER_TYPE_SCOPED` | engine | `crates/memstead-base/src/ops/mod.rs:1441` |
...
| `READ_VAULT_SHADOWS_WRITABLE` | CLI | `crates/memstead-cli/src/commands/install.rs:446` |
...
| `RENAME_BLOCKED_BY_CROSS_VAULT_POLICY` | engine | `crates/memstead-base/src/engine/error.rs:1004` |
...
| `RESIDUAL_STUB_FOR_READONLY_REFERRERS` | engine | `crates/memstead-base/src/ops/mod.rs:1460` |
| `SCHEMA_NOT_FOUND` | engine | `crates/memstead-base/src/engine/error.rs:1026` |
| `SCHEMA_PIN_MISMATCH` | engine | `crates/memstead-base/src/ops/mod.rs:1455` |
...
| `SEARCH_RESULTS_TRUNCATED` | engine | `crates/memstead-base/src/ops/mod.rs:1435` |
| `SEARCH_UNAVAILABLE_IN_WASM` | engine | `crates/memstead-base/src/engine/error.rs:1039` |
| `SEARCH_VAULT_INDEX_UNAVAILABLE` | engine | `crates/memstead-base/src/ops/mod.rs:1445` |
...
| `SELF_LINK_IGNORED` | engine | `crates/memstead-base/src/ops/mod.rs:1457` |
...
| `STUB_FILTER_EXCLUDES_ALL` | engine | `crates/memstead-base/src/ops/mod.rs:1415` |
...
| `SUSPICIOUS_NESTED_PREFIX` | engine | `crates/memstead-base/src/ops/mod.rs:1447` |
| `TARGET_NOT_EMPTY` | CLI | `crates/memstead-cli/src/lib.rs:38` |
| `TITLE_NORMALIZED_TO_SLUG_NOOP` | engine | `crates/memstead-base/src/ops/mod.rs:1413` |
| `TITLE_TRIMMED` | engine | `crates/memstead-base/src/ops/mod.rs:1446` |
| `UNDECLARED_RELATIONSHIP_OPEN` | engine | `crates/memstead-base/src/ops/mod.rs:1408` |
| `UNKNOWN_ENTITY_TYPE` | engine | `crates/memstead-base/src/engine/error.rs:990` |
| `UNKNOWN_FILTER_KEY` | engine | `crates/memstead-base/src/ops/mod.rs:1426` |
| `UNKNOWN_INCLUDE_KEY` | engine | `crates/memstead-base/src/ops/mod.rs:1411` |
| `UNKNOWN_METADATA_FIELD` | engine | `crates/memstead-base/src/runtime_validator.rs:196` |
| `UNKNOWN_RANGE_FILTER_FIELD` | engine | `crates/memstead-base/src/ops/mod.rs:1439` |
...
| `UNKNOWN_VAULT` | engine | `crates/memstead-base/src/engine/error.rs:981` |
| `UPDATE_NOOP` | engine | `crates/memstead-base/src/ops/mod.rs:1414` |
| `VAULT_CONFIG_INCOMPLETE` | engine | `crates/memstead-base/src/engine/error.rs:1033` |
| `VAULT_ERROR` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1025`<br>`crates/memstead-base/src/engine/error.rs:1028`<br>`crates/memstead-mcp/src/filesystem_server.rs:772` |
| `VAULT_FILES_NOT_DELETED` | engine | `crates/memstead-base/src/ops/mod.rs:1462` |
| `VAULT_HAS_INCOMING_REFS` | engine | `crates/memstead-base/src/engine/error.rs:996` |
| `VAULT_NAME_COLLISION` | engine | `crates/memstead-base/src/engine/error.rs:1029` |
| `VAULT_REATTACHED_AFTER_UNREGISTER` | engine | `crates/memstead-base/src/ops/mod.rs:1463` |
| `VAULT_RELOADED` | engine | `crates/memstead-base/src/ops/mod.rs:1453` |
...
| `WORKSPACE_CONFIG_INVALID` | CLI | `crates/memstead-cli/src/commands/install.rs:275`<br>`crates/memstead-cli/src/commands/install.rs:282`<br>`crates/memstead-cli/src/commands/install.rs:324`<br>`crates/memstead-cli/src/commands/install.rs:331` |
| `WORKSPACE_CONFIG_READ_FAILED` | CLI | `crates/memstead-cli/src/commands/install.rs:272` |
