...
| `BATCH_REFUSED` | CLI, MCP | `crates/memstead-cli/src/commands/batch.rs:117`<br>`crates/memstead-mcp/src/server.rs:3039` |
| `BRANCH_RESET_HEAD_MOVED` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1199`<br>`crates/memstead-mcp/src/server.rs:844` |
| `CHANGELOG_ERROR` | MCP | `crates/memstead-mcp/src/filesystem_server.rs:2031` |
| `CHECK_NOT_RECORDED` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1201`<br>`crates/memstead-mcp/src/server.rs:944` |
| `CHUNK_OUT_OF_RANGE` | CLI | `crates/memstead-cli/src/commands/context.rs:44`<br>`crates/memstead-cli/src/commands/entity.rs:134`<br>`crates/memstead-cli/src/commands/overview.rs:148`<br>`crates/memstead-cli/src/commands/overview.rs:234`<br>`crates/memstead-cli/src/lib.rs:42` |
| `CONFIG_ERROR` | MCP | `crates/memstead-mcp/src/server.rs:1814` |
| `CONFLICTING_SECTION_MODES` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1230`<br>`crates/memstead-mcp/src/server.rs:1085` |
| `CONFLICT_RESOLVE_UNSUPPORTED_BACKEND` | engine | `crates/memstead-base/src/engine/error.rs:1249` |
| `CONSTRAINT_UNSATISFIED` | engine | `crates/memstead-base/src/engine/error.rs:1205`<br>`crates/memstead-base/src/ops/mod.rs:1773` |
| `CONTEXT_NOT_COMPUTABLE` | CLI | `crates/memstead-cli/src/commands/context.rs:54` |
| `CROSS_MEM_EDGE_NOT_DECLARED` | engine | `crates/memstead-base/src/engine/error.rs:1214` |
| `CROSS_MEM_LINK_NOT_ALLOWED` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1212`<br>`crates/memstead-mcp/src/filesystem_server.rs:459` |
| `CROSS_MEM_TARGET_MEM_UNCREATED` | engine | `crates/memstead-base/src/ops/mod.rs:1719` |
| `CROSS_MEM_TARGET_NOT_FOUND` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1213`<br>`crates/memstead-mcp/src/filesystem_server.rs:468` |
| `DERIVATION_BASELINE_REFRESHED` | engine | `crates/memstead-base/src/ops/mod.rs:1782` |
| `DESCRIPTION_NOT_PERMITTED` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1257`<br>`crates/memstead-base/src/ops/mod.rs:1795`<br>`crates/memstead-mcp/src/server.rs:1512` |
...
| `DUPLICATE_MEM` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1189`<br>`crates/memstead-mcp/src/server.rs:1617` |
...
| `EMBEDDED_SCHEMA_INVALID` | engine, CLI, MCP | `crates/memstead-base/src/engine/error.rs:1242`<br>`crates/memstead-cli/src/commands/install.rs:238`<br>`crates/memstead-mcp/src/server.rs:1401` |
| `EMPTY_UPDATE` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1217`<br>`crates/memstead-mcp/src/server.rs:1685` |
...
| `ENTITY_ALREADY_EXISTS` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1204`<br>`crates/memstead-mcp/src/server.rs:765` |
| `ENTITY_NOT_FOUND` | engine, CLI, MCP | `crates/memstead-base/src/engine/error.rs:1208`<br>`crates/memstead-cli/src/commands/context.rs:60`<br>`crates/memstead-cli/src/commands/delete.rs:55`<br>`crates/memstead-cli/src/commands/delete.rs:84`<br>`crates/memstead-cli/src/commands/delete.rs:127`<br>`crates/memstead-cli/src/commands/delete.rs:151`<br>`crates/memstead-cli/src/commands/entity.rs:58`<br>`crates/memstead-cli/src/commands/relations.rs:72`<br>`crates/memstead-cli/src/commands/rename.rs:139`<br>`crates/memstead-cli/src/commands/rename.rs:173`<br>`crates/memstead-cli/src/commands/update.rs:721`<br>`crates/memstead-cli/src/commands/update.rs:744`<br>`crates/memstead-mcp/src/filesystem_server.rs:370`<br>`crates/memstead-mcp/src/filesystem_server.rs:1062`<br>`crates/memstead-mcp/src/filesystem_server.rs:1895`<br>`crates/memstead-mcp/src/server.rs:755`<br>`crates/memstead-mcp/src/server.rs:1897`<br>`crates/memstead-mcp/src/server.rs:2489` |
...
| `HASH_MISMATCH` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1209`<br>`crates/memstead-mcp/src/server.rs:786` |
| `HAS_INCOMING_REFS` | engine | `crates/memstead-base/src/engine/error.rs:1210` |
...
| `INVALID_CURSOR` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1253`<br>`crates/memstead-mcp/src/server.rs:1700` |
| `INVALID_DOMAIN` | CLI | `crates/memstead-cli/src/commands/domain.rs:148` |
| `INVALID_ENTITY_ID` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1227`<br>`crates/memstead-mcp/src/server.rs:310`<br>`crates/memstead-mcp/src/server.rs:325`<br>`crates/memstead-mcp/src/server.rs:1311` |
...
| `INVALID_TITLE` | engine, CLI, MCP | `crates/memstead-base/src/engine/error.rs:1203`<br>`crates/memstead-cli/src/commands/batch_create.rs:196`<br>`crates/memstead-cli/src/commands/create.rs:227`<br>`crates/memstead-mcp/src/server.rs:1278` |
| `INVALID_VERDICT` | CLI, MCP | `crates/memstead-cli/src/commands/check.rs:41`<br>`crates/memstead-mcp/src/server.rs:3258` |
| `INVALID_VERSION` | CLI | `crates/memstead-cli/src/commands/publish.rs:144` |
| `INVALID_WIKI_LINK_TARGET` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1228`<br>`crates/memstead-mcp/src/server.rs:1326` |
...
| `LOCAL_DIVERGENCE` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1194`<br>`crates/memstead-mcp/src/server.rs:883` |
| `LOCAL_INVALID_STATE` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1196`<br>`crates/memstead-mcp/src/server.rs:905` |
| `LOGIN_FAILED` | CLI | `crates/memstead-cli/src/commands/login.rs:40`<br>`crates/memstead-cli/src/commands/publish.rs:497` |
| `MARKDOWN_EXPORT_UNSUPPORTED_BACKEND` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1263`<br>`crates/memstead-mcp/src/server.rs:1672` |
| `MEM_CONFIG_INCOMPLETE` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1255`<br>`crates/memstead-mcp/src/server.rs:1483` |
| `MEM_ERROR` | engine, CLI, MCP | `crates/memstead-base/src/engine/error.rs:1240`<br>`crates/memstead-base/src/engine/error.rs:1245`<br>`crates/memstead-cli/src/commands/workspace.rs:767`<br>`crates/memstead-cli/src/commands/workspace.rs:774`<br>`crates/memstead-mcp/src/filesystem_server.rs:853`<br>`crates/memstead-mcp/src/server.rs:1435`<br>`crates/memstead-mcp/src/server.rs:1647` |
| `MEM_FILES_NOT_DELETED` | engine | `crates/memstead-base/src/ops/mod.rs:1786` |
| `MEM_HAS_INCOMING_REFS` | engine | `crates/memstead-base/src/engine/error.rs:1211` |
| `MEM_NAME_COLLISION` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1246`<br>`crates/memstead-mcp/src/server.rs:1384` |
...
| `MEM_QUARANTINED` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1191`<br>`crates/memstead-mcp/src/server.rs:818` |
...
| `MISSING_REQUIRED_DESCRIPTION` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1256`<br>`crates/memstead-base/src/ops/mod.rs:1794`<br>`crates/memstead-mcp/src/server.rs:1529` |
| `MISSING_REQUIRED_FIELD` | engine | `crates/memstead-base/src/ops/mod.rs:1721` |
| `MISSING_REQUIRED_OUTGOING` | engine | `crates/memstead-base/src/engine/error.rs:1206`<br>`crates/memstead-base/src/ops/mod.rs:1772` |
| `MISSING_REQUIRED_SECTION` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1234`<br>`crates/memstead-base/src/ops/mod.rs:1720`<br>`crates/memstead-mcp/src/server.rs:1206` |
...
| `NON_FAST_FORWARD` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1195`<br>`crates/memstead-mcp/src/server.rs:892` |
...
| `NOT_CONFLICTED` | engine | `crates/memstead-base/src/engine/error.rs:1251` |
...
| `PARSE_ERROR` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1238`<br>`crates/memstead-base/src/engine/error.rs:1239`<br>`crates/memstead-mcp/src/filesystem_server.rs:855`<br>`crates/memstead-mcp/src/filesystem_server.rs:857`<br>`crates/memstead-mcp/src/server.rs:1629`<br>`crates/memstead-mcp/src/server.rs:1638` |
| `PATCH_OLD_NOT_FOUND` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1236`<br>`crates/memstead-mcp/src/server.rs:1234` |
| `PATCH_SECTION_EMPTY` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1235`<br>`crates/memstead-mcp/src/filesystem_server.rs:829`<br>`crates/memstead-mcp/src/server.rs:1221` |
...
| `PUSHED_COMMITS_PROTECTED` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1198`<br>`crates/memstead-mcp/src/server.rs:861` |
...
| `READ_ONLY_MOUNT` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1200`<br>`crates/memstead-mcp/src/server.rs:935` |
...
| `RELATIONSHIP_CYCLE` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1231`<br>`crates/memstead-mcp/src/server.rs:1103` |
| `RELATION_HAS_BODY_LINKS` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1222`<br>`crates/memstead-mcp/src/server.rs:1363` |
| `RELATION_MANUAL_AUTHORING_FORBIDDEN` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1259`<br>`crates/memstead-mcp/src/server.rs:1547` |
| `RENAME_BLOCKED_BY_CROSS_MEM_POLICY` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1219`<br>`crates/memstead-mcp/src/server.rs:1587` |
| `RENAME_NO_OP` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1216`<br>`crates/memstead-mcp/src/filesystem_server.rs:510`<br>`crates/memstead-mcp/src/server.rs:1561` |
| `RENAME_PARTIAL_FAILURE` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1221`<br>`crates/memstead-mcp/src/server.rs:1604` |
| `REPAIR_NOT_NEEDED` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1215`<br>`crates/memstead-mcp/src/server.rs:1076` |
| `REQUIRED_FIELD_UNSET` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1233`<br>`crates/memstead-mcp/src/server.rs:1145` |
| `RESIDUAL_STUB_FOR_READONLY_REFERRERS` | engine | `crates/memstead-base/src/ops/mod.rs:1785` |
| `REVIEW_MARK_NOT_SET` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1254`<br>`crates/memstead-mcp/src/server.rs:1711` |
...
| `SCHEMA_NOT_FOUND` | engine, CLI, MCP | `crates/memstead-base/src/engine/error.rs:1241`<br>`crates/memstead-cli/src/commands/schema.rs:845`<br>`crates/memstead-cli/src/commands/schema.rs:879`<br>`crates/memstead-cli/src/commands/schema.rs:895`<br>`crates/memstead-mcp/src/server.rs:1396` |
...
| `SCHEMA_RESOLVER_INIT_FAILED` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1244`<br>`crates/memstead-mcp/src/server.rs:1426` |
| `SCHEMA_UNSTAMPED_SOURCE_ROT` | engine | `crates/memstead-base/src/ops/mod.rs:1792` |
| `SCHEMA_VALIDATION_FAILED` | engine, CLI, MCP | `crates/memstead-base/src/engine/error.rs:1243`<br>`crates/memstead-cli/src/commands/schema.rs:596`<br>`crates/memstead-cli/src/commands/schema.rs:624`<br>`crates/memstead-cli/src/commands/schema.rs:649`<br>`crates/memstead-cli/src/commands/schema.rs:794`<br>`crates/memstead-cli/src/commands/schema.rs:806`<br>`crates/memstead-mcp/src/server.rs:1414` |
| `SCHEMA_VIOLATION_IN_FETCH` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1197`<br>`crates/memstead-mcp/src/server.rs:922` |
...
| `SEARCH_UNAVAILABLE_IN_WASM` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1261`<br>`crates/memstead-mcp/src/server.rs:1656` |
...
| `SET_AND_UNSET_CONFLICT` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1232`<br>`crates/memstead-mcp/src/server.rs:1212` |
| `SOURCE_UNREACHABLE` | CLI | `crates/memstead-cli/src/commands/projection.rs:2092` |
| `STUB_CANNOT_RELATE` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1224`<br>`crates/memstead-mcp/src/server.rs:1284` |
| `STUB_FILTER_EXCLUDES_ALL` | engine | `crates/memstead-base/src/ops/mod.rs:1730` |
| `STUB_NOT_RENAMABLE` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1226`<br>`crates/memstead-mcp/src/server.rs:1302` |
| `STUB_NOT_UPDATABLE` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1225`<br>`crates/memstead-mcp/src/server.rs:1293` |
...
| `UNKNOWN_ENTITY_TYPE` | engine, CLI, MCP | `crates/memstead-base/src/engine/error.rs:1202`<br>`crates/memstead-cli/src/commands/type_cmd.rs:54`<br>`crates/memstead-mcp/src/filesystem_server.rs:309`<br>`crates/memstead-mcp/src/server.rs:958`<br>`crates/memstead-mcp/src/server.rs:2575` |
...
| `UNKNOWN_REF` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1192`<br>`crates/memstead-mcp/src/server.rs:831` |
| `UNKNOWN_REMOTE` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1193`<br>`crates/memstead-mcp/src/server.rs:874` |
...
| `WIKILINK_WITHOUT_RELATION` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1223`<br>`crates/memstead-mcp/src/server.rs:1496` |
