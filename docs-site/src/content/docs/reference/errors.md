...
| `MEM_REPO_NOT_SUPPORTED` | CLI | `crates/memstead-cli/src/commands/schema.rs:697` |
...
| `SCHEMA_NOT_FOUND` | engine, CLI, MCP | `crates/memstead-base/src/engine/error.rs:1187`<br>`crates/memstead-cli/src/commands/schema.rs:769`<br>`crates/memstead-cli/src/commands/schema.rs:803`<br>`crates/memstead-cli/src/commands/schema.rs:819`<br>`crates/memstead-mcp/src/server.rs:1379` |
...
| `SCHEMA_VALIDATION_FAILED` | engine, CLI, MCP | `crates/memstead-base/src/engine/error.rs:1188`<br>`crates/memstead-cli/src/commands/schema.rs:559`<br>`crates/memstead-cli/src/commands/schema.rs:584`<br>`crates/memstead-cli/src/commands/schema.rs:725`<br>`crates/memstead-cli/src/commands/schema.rs:737`<br>`crates/memstead-mcp/src/server.rs:1388` |
