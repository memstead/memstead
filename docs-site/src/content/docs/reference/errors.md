...
| `BATCH_REFUSED` | CLI, MCP | `crates/memstead-cli/src/commands/batch.rs:117`<br>`crates/memstead-cli/src/commands/check.rs:344`<br>`crates/memstead-mcp/src/filesystem_server.rs:1673`<br>`crates/memstead-mcp/src/server.rs:3212` |
...
| `CHANGELOG_ERROR` | MCP | `crates/memstead-mcp/src/filesystem_server.rs:2212` |
...
| `EXPECTED_HASH_REQUIRED` | MCP | `crates/memstead-mcp/src/filesystem_server.rs:1431`<br>`crates/memstead-mcp/src/server.rs:2955` |
...
| `HEALTH_STRICT_VIOLATIONS` | CLI | `crates/memstead-cli/src/commands/health.rs:1697` |
...
| `INTERNAL` | CLI, MCP | `crates/memstead-cli/src/lib.rs:29`<br>`crates/memstead-mcp/src/filesystem_server.rs:1949`<br>`crates/memstead-mcp/src/filesystem_server.rs:2012`<br>`crates/memstead-mcp/src/filesystem_server.rs:2042` |
...
| `INVALID_CHECK_KIND` | CLI, MCP | `crates/memstead-cli/src/commands/check.rs:109`<br>`crates/memstead-mcp/src/filesystem_server.rs:2432`<br>`crates/memstead-mcp/src/server.rs:3455` |
| `INVALID_CURSOR` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1392`<br>`crates/memstead-base/src/engine/error.rs:1393`<br>`crates/memstead-mcp/src/filesystem_server.rs:1081`<br>`crates/memstead-mcp/src/filesystem_server.rs:2237`<br>`crates/memstead-mcp/src/server.rs:1796` |
...
| `INVALID_VERDICT` | CLI, MCP | `crates/memstead-cli/src/commands/check.rs:154`<br>`crates/memstead-mcp/src/filesystem_server.rs:2415`<br>`crates/memstead-mcp/src/server.rs:3434` |
