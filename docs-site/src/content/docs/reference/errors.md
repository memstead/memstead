...
| `ENTITY_NOT_FOUND` | engine, CLI, MCP | `crates/memstead-base/src/engine/error.rs:1352`<br>`crates/memstead-cli/src/commands/context.rs:60`<br>`crates/memstead-cli/src/commands/delete.rs:59`<br>`crates/memstead-cli/src/commands/delete.rs:88`<br>`crates/memstead-cli/src/commands/delete.rs:132`<br>`crates/memstead-cli/src/commands/delete.rs:156`<br>`crates/memstead-cli/src/commands/entity.rs:60`<br>`crates/memstead-cli/src/commands/relations.rs:72`<br>`crates/memstead-cli/src/commands/rename.rs:147`<br>`crates/memstead-cli/src/commands/rename.rs:181`<br>`crates/memstead-cli/src/commands/retype.rs:230`<br>`crates/memstead-cli/src/commands/update.rs:861`<br>`crates/memstead-cli/src/commands/update.rs:885`<br>`crates/memstead-mcp/src/filesystem_server.rs:430`<br>`crates/memstead-mcp/src/filesystem_server.rs:1135`<br>`crates/memstead-mcp/src/filesystem_server.rs:2100`<br>`crates/memstead-mcp/src/server.rs:820`<br>`crates/memstead-mcp/src/server.rs:2008`<br>`crates/memstead-mcp/src/server.rs:2642` |
