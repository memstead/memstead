...
| `INTERNAL` | CLI, MCP | `crates/memstead-cli/src/commands/schema.rs:618`<br>`crates/memstead-cli/src/lib.rs:28`<br>`crates/memstead-mcp/src/filesystem_server.rs:1545` |
...
| `READ_MEM_SHADOWS_WRITABLE` | CLI | `crates/memstead-cli/src/commands/install.rs:222` |
