...
| `BATCH_REFUSED` | CLI, MCP | `crates/memstead-cli/src/commands/batch.rs:92`<br>`crates/memstead-mcp/src/server.rs:2953` |
...
| `CHANGELOG_ERROR` | MCP | `crates/memstead-mcp/src/filesystem_server.rs:1957` |
...
| `CONFIG_ERROR` | MCP | `crates/memstead-mcp/src/server.rs:1792` |
...
| `CONSTRAINT_UNSATISFIED` | engine | `crates/memstead-base/src/engine/error.rs:1151`<br>`crates/memstead-base/src/ops/mod.rs:1719` |
...
| `CROSS_MEM_LINK_NOT_ALLOWED` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1158`<br>`crates/memstead-mcp/src/filesystem_server.rs:476` |
| `CROSS_MEM_TARGET_MEM_UNCREATED` | engine | `crates/memstead-base/src/ops/mod.rs:1666` |
| `CROSS_MEM_TARGET_NOT_FOUND` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1159`<br>`crates/memstead-mcp/src/filesystem_server.rs:485` |
| `DERIVATION_BASELINE_REFRESHED` | engine | `crates/memstead-base/src/ops/mod.rs:1728` |
| `DESCRIPTION_NOT_PERMITTED` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1198`<br>`crates/memstead-base/src/ops/mod.rs:1740`<br>`crates/memstead-mcp/src/server.rs:1490` |
...
| `DUPLICATE_MEM` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1135`<br>`crates/memstead-mcp/src/server.rs:1595` |
...
| `EMPTY_UPDATE` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1163`<br>`crates/memstead-mcp/src/server.rs:1663` |
...
| `INTERNAL` | CLI, MCP | `crates/memstead-cli/src/lib.rs:28`<br>`crates/memstead-mcp/src/filesystem_server.rs:1771`<br>`crates/memstead-mcp/src/filesystem_server.rs:1831` |
| `INVALID_ANCHOR` | engine | `crates/memstead-base/src/anchor.rs:67` |
| `INVALID_CURSOR` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1194`<br>`crates/memstead-mcp/src/server.rs:1678` |
| `INVALID_DOMAIN` | CLI | `crates/memstead-cli/src/commands/domain.rs:148` |
| `INVALID_ENTITY_ID` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1173`<br>`crates/memstead-mcp/src/server.rs:311`<br>`crates/memstead-mcp/src/server.rs:326`<br>`crates/memstead-mcp/src/server.rs:1308` |
...
| `INVALID_TITLE` | engine, CLI, MCP | `crates/memstead-base/src/engine/error.rs:1149`<br>`crates/memstead-cli/src/commands/batch_create.rs:192`<br>`crates/memstead-cli/src/commands/create.rs:226`<br>`crates/memstead-mcp/src/server.rs:1275` |
| `INVALID_VERDICT` | CLI, MCP | `crates/memstead-cli/src/commands/check.rs:41`<br>`crates/memstead-mcp/src/server.rs:3171` |
| `INVALID_VERSION` | CLI | `crates/memstead-cli/src/commands/publish.rs:129` |
| `INVALID_WIKI_LINK_TARGET` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1174`<br>`crates/memstead-mcp/src/server.rs:1323` |
...
| `MARKDOWN_EXPORT_UNSUPPORTED_BACKEND` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1204`<br>`crates/memstead-mcp/src/server.rs:1650` |
| `MEM_CONFIG_INCOMPLETE` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1196`<br>`crates/memstead-mcp/src/server.rs:1461` |
| `MEM_ERROR` | engine, CLI, MCP | `crates/memstead-base/src/engine/error.rs:1186`<br>`crates/memstead-base/src/engine/error.rs:1190`<br>`crates/memstead-cli/src/commands/workspace.rs:762`<br>`crates/memstead-cli/src/commands/workspace.rs:769`<br>`crates/memstead-mcp/src/filesystem_server.rs:852`<br>`crates/memstead-mcp/src/server.rs:1423`<br>`crates/memstead-mcp/src/server.rs:1625` |
...
| `MEM_NAME_COLLISION` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1191`<br>`crates/memstead-mcp/src/server.rs:1381` |
| `MEM_NOT_READ_ONLY` | CLI | `crates/memstead-cli/src/commands/uninstall.rs:48` |
| `MEM_PATH_NOT_ALLOWED` | MCP | `crates/memstead-mcp/src/server.rs:1741` |
...
| `MEM_REFERENCED_BY_POLICY` | MCP | `crates/memstead-mcp/src/server.rs:1780` |
...
| `MEM_SCHEMA_NOT_ALLOWED` | MCP | `crates/memstead-mcp/src/server.rs:1763` |
| `MEM_STORAGE_RESIDUE_DETECTED` | MCP | `crates/memstead-mcp/src/server.rs:1808` |
| `MISSING_REQUIRED_DESCRIPTION` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1197`<br>`crates/memstead-base/src/ops/mod.rs:1739`<br>`crates/memstead-mcp/src/server.rs:1507` |
| `MISSING_REQUIRED_FIELD` | engine | `crates/memstead-base/src/ops/mod.rs:1668` |
| `MISSING_REQUIRED_OUTGOING` | engine | `crates/memstead-base/src/engine/error.rs:1152`<br>`crates/memstead-base/src/ops/mod.rs:1718` |
| `MISSING_REQUIRED_SECTION` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1180`<br>`crates/memstead-base/src/ops/mod.rs:1667`<br>`crates/memstead-mcp/src/server.rs:1180` |
...
| `PARSE_ERROR` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1184`<br>`crates/memstead-base/src/engine/error.rs:1185`<br>`crates/memstead-mcp/src/filesystem_server.rs:854`<br>`crates/memstead-mcp/src/filesystem_server.rs:856`<br>`crates/memstead-mcp/src/server.rs:1607`<br>`crates/memstead-mcp/src/server.rs:1616` |
| `PATCH_OLD_NOT_FOUND` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1182`<br>`crates/memstead-mcp/src/server.rs:1217` |
| `PATCH_SECTION_EMPTY` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1181`<br>`crates/memstead-mcp/src/filesystem_server.rs:828`<br>`crates/memstead-mcp/src/server.rs:1204` |
...
| `RELATION_HAS_BODY_LINKS` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1168`<br>`crates/memstead-mcp/src/server.rs:1360` |
| `RELATION_MANUAL_AUTHORING_FORBIDDEN` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1200`<br>`crates/memstead-mcp/src/server.rs:1525` |
| `RENAME_BLOCKED_BY_CROSS_MEM_POLICY` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1165`<br>`crates/memstead-mcp/src/server.rs:1565` |
| `RENAME_NO_OP` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1162`<br>`crates/memstead-mcp/src/filesystem_server.rs:527`<br>`crates/memstead-mcp/src/server.rs:1539` |
| `RENAME_PARTIAL_FAILURE` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1167`<br>`crates/memstead-mcp/src/server.rs:1582` |
...
| `REVIEW_MARK_NOT_SET` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1195`<br>`crates/memstead-mcp/src/server.rs:1689` |
...
| `SCHEMA_NOT_FOUND` | engine, CLI, MCP | `crates/memstead-base/src/engine/error.rs:1187`<br>`crates/memstead-cli/src/commands/schema.rs:754`<br>`crates/memstead-cli/src/commands/schema.rs:788`<br>`crates/memstead-cli/src/commands/schema.rs:804`<br>`crates/memstead-mcp/src/server.rs:1393` |
...
| `SCHEMA_RESOLVER_INIT_FAILED` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1189`<br>`crates/memstead-mcp/src/server.rs:1414` |
| `SCHEMA_VALIDATION_FAILED` | engine, CLI, MCP | `crates/memstead-base/src/engine/error.rs:1188`<br>`crates/memstead-cli/src/commands/schema.rs:544`<br>`crates/memstead-cli/src/commands/schema.rs:569`<br>`crates/memstead-cli/src/commands/schema.rs:710`<br>`crates/memstead-cli/src/commands/schema.rs:722`<br>`crates/memstead-mcp/src/server.rs:1402` |
...
| `SEARCH_UNAVAILABLE_IN_WASM` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1202`<br>`crates/memstead-mcp/src/server.rs:1634` |
...
| `STUB_CANNOT_RELATE` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1170`<br>`crates/memstead-mcp/src/server.rs:1281` |
| `STUB_FILTER_EXCLUDES_ALL` | engine | `crates/memstead-base/src/ops/mod.rs:1676` |
| `STUB_NOT_RENAMABLE` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1172`<br>`crates/memstead-mcp/src/server.rs:1299` |
| `STUB_NOT_UPDATABLE` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1171`<br>`crates/memstead-mcp/src/server.rs:1290` |
...
| `WIKILINK_WITHOUT_RELATION` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1169`<br>`crates/memstead-mcp/src/server.rs:1474` |
