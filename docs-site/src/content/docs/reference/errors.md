...
| `ANCHORS_SIDECAR_UNREADABLE` | CLI | `crates/memstead-cli/src/commands/projection.rs:2233` |
...
| `DESCRIPTION_NOT_PERMITTED` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1336`<br>`crates/memstead-base/src/ops/mod.rs:1985`<br>`crates/memstead-mcp/src/filesystem_server.rs:954`<br>`crates/memstead-mcp/src/server.rs:1595` |
...
| `MISSING_REQUIRED_DESCRIPTION` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1335`<br>`crates/memstead-base/src/ops/mod.rs:1984`<br>`crates/memstead-mcp/src/filesystem_server.rs:941`<br>`crates/memstead-mcp/src/server.rs:1612` |
...
| `MISSING_REQUIRED_SECTION` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1309`<br>`crates/memstead-base/src/ops/mod.rs:1906`<br>`crates/memstead-mcp/src/filesystem_server.rs:890`<br>`crates/memstead-mcp/src/server.rs:1289` |
...
| `NO_ACTIVE_BINDING` | CLI | `crates/memstead-cli/src/commands/projection.rs:1804` |
...
| `PROJECTION_ADVANCE_FAILED` | CLI | `crates/memstead-cli/src/commands/projection.rs:1885`<br>`crates/memstead-cli/src/commands/projection.rs:1930`<br>`crates/memstead-cli/src/commands/projection.rs:1965` |
| `PROJECTION_ADVANCE_UNKNOWN_ARTIFACT` | CLI | `crates/memstead-cli/src/commands/projection.rs:1920` |
| `PROJECTION_BRIEF_BINDING_REQUIRED` | CLI | `crates/memstead-cli/src/commands/projection.rs:667` |
| `PROJECTION_BUILD_NOT_ENABLED` | CLI | `crates/memstead-cli/src/commands/projection.rs:607` |
| `PROJECTION_CAPABILITY_UNSUPPORTED` | CLI | `crates/memstead-cli/src/commands/projection.rs:570`<br>`crates/memstead-cli/src/commands/projection.rs:1599`<br>`crates/memstead-cli/src/commands/projection.rs:2283` |
| `PROJECTION_EDIT_FAILED` | CLI | `crates/memstead-cli/src/commands/projection.rs:1746` |
| `PROJECTION_EDIT_INVALID_JSON` | CLI | `crates/memstead-cli/src/commands/projection.rs:1723` |
| `PROJECTION_EDIT_REFUSED` | CLI | `crates/memstead-cli/src/commands/projection.rs:1729` |
| `PROJECTION_ENABLE_FAILED` | CLI | `crates/memstead-cli/src/commands/projection.rs:1467` |
| `PROJECTION_EXCLUDE_FAILED` | CLI | `crates/memstead-cli/src/commands/projection.rs:2062`<br>`crates/memstead-cli/src/commands/projection.rs:2096` |
| `PROJECTION_EXCLUDE_NOT_SOURCE_MEMBER` | CLI | `crates/memstead-cli/src/commands/projection.rs:2057` |
| `PROJECTION_EXISTS` | CLI | `crates/memstead-cli/src/commands/projection.rs:900` |
| `PROJECTION_FINDINGS_READ_FAILED` | CLI | `crates/memstead-cli/src/commands/projection.rs:613` |
| `PROJECTION_INIT_FAILED` | CLI | `crates/memstead-cli/src/commands/projection.rs:849`<br>`crates/memstead-cli/src/commands/quickstart.rs:596` |
| `PROJECTION_INVALID_DISPOSITIONS` | CLI | `crates/memstead-cli/src/commands/projection.rs:1951` |
| `PROJECTION_INVALID_EXCLUSIONS` | CLI | `crates/memstead-cli/src/commands/projection.rs:2083` |
| `PROJECTION_INVALID_NAME` | CLI | `crates/memstead-cli/src/commands/projection.rs:621`<br>`crates/memstead-cli/src/commands/projection.rs:874`<br>`crates/memstead-cli/src/commands/projection.rs:1450`<br>`crates/memstead-cli/src/commands/projection.rs:1878`<br>`crates/memstead-cli/src/commands/projection.rs:1898`<br>`crates/memstead-cli/src/commands/projection.rs:2052` |
| `PROJECTION_LOAD_FAILED` | CLI | `crates/memstead-cli/src/commands/projection.rs:601`<br>`crates/memstead-cli/src/commands/projection.rs:684`<br>`crates/memstead-cli/src/commands/projection.rs:730`<br>`crates/memstead-cli/src/commands/projection.rs:1814` |
| `PROJECTION_MIGRATE_DANGLING_REF` | CLI | `crates/memstead-cli/src/commands/projection.rs:1011` |
| `PROJECTION_MIGRATE_FAILED` | CLI | `crates/memstead-cli/src/commands/projection.rs:1037`<br>`crates/memstead-cli/src/commands/projection.rs:1232`<br>`crates/memstead-cli/src/commands/projection.rs:1344`<br>`crates/memstead-cli/src/commands/projection.rs:1353`<br>`crates/memstead-cli/src/commands/projection.rs:1363` |
| `PROJECTION_MIGRATE_INERT_PROJECTION` | CLI | `crates/memstead-cli/src/commands/projection.rs:1284` |
| `PROJECTION_MIGRATE_MALFORMED_REF` | CLI | `crates/memstead-cli/src/commands/projection.rs:1004` |
| `PROJECTION_MIGRATE_ORPHAN_RECORDS` | CLI | `crates/memstead-cli/src/commands/projection.rs:1016` |
| `PROJECTION_MIGRATE_REFINEMENT` | CLI | `crates/memstead-cli/src/commands/projection.rs:999` |
| `PROJECTION_NOT_FOUND` | CLI | `crates/memstead-cli/src/commands/projection.rs:618`<br>`crates/memstead-cli/src/commands/projection.rs:1121`<br>`crates/memstead-cli/src/commands/projection.rs:1505`<br>`crates/memstead-cli/src/commands/projection.rs:1714` |
| `PROJECTION_OP_ALREADY_ENABLED` | CLI | `crates/memstead-cli/src/commands/projection.rs:1540` |
| `PROJECTION_QUARANTINED` | CLI | `crates/memstead-cli/src/commands/projection.rs:1105` |
| `PROJECTION_SCOPE_UNINTERPRETABLE` | CLI | `crates/memstead-cli/src/commands/projection.rs:628`<br>`crates/memstead-cli/src/commands/projection.rs:1882` |
| `PROJECTION_STORE_LEGACY` | engine | `crates/memstead-base/src/workspace_store.rs:166` |
| `PROJECTION_SYNC_NOT_ENABLED` | CLI | `crates/memstead-cli/src/commands/projection.rs:580` |
| `PROJECTION_VERIFY_BACKFILL_FAILED` | CLI | `crates/memstead-cli/src/commands/projection.rs:2432` |
| `PROJECTION_VERIFY_BASELINE_FAILED` | CLI | `crates/memstead-cli/src/commands/projection.rs:2444` |
| `PROJECTION_VERIFY_FAILED` | CLI | `crates/memstead-cli/src/commands/projection.rs:2203`<br>`crates/memstead-cli/src/commands/projection.rs:2294` |
| `PROJECTION_VERIFY_FINDINGS` | CLI | `crates/memstead-cli/src/commands/projection.rs:2465` |
...
| `SOURCE_UNREACHABLE` | CLI | `crates/memstead-cli/src/commands/projection.rs:2262` |
