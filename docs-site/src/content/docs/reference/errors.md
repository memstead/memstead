...
| `BATCH_REFUSED` | CLI, MCP | `crates/memstead-cli/src/commands/batch.rs:117`<br>`crates/memstead-mcp/src/server.rs:2996` |
| `BRANCH_RESET_HEAD_MOVED` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1183`<br>`crates/memstead-mcp/src/server.rs:844` |
| `CHANGELOG_ERROR` | MCP | `crates/memstead-mcp/src/filesystem_server.rs:1992` |
| `CHECK_NOT_RECORDED` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1185`<br>`crates/memstead-mcp/src/server.rs:944` |
...
| `CONFIG_ERROR` | MCP | `crates/memstead-mcp/src/server.rs:1796` |
| `CONFLICTING_SECTION_MODES` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1214`<br>`crates/memstead-mcp/src/server.rs:1085` |
| `CONFLICT_RESOLVE_UNSUPPORTED_BACKEND` | engine | `crates/memstead-base/src/engine/error.rs:1233` |
| `CONSTRAINT_UNSATISFIED` | engine | `crates/memstead-base/src/engine/error.rs:1189`<br>`crates/memstead-base/src/ops/mod.rs:1773` |
| `CONTEXT_NOT_COMPUTABLE` | CLI | `crates/memstead-cli/src/commands/context.rs:54` |
| `CROSS_MEM_EDGE_NOT_DECLARED` | engine | `crates/memstead-base/src/engine/error.rs:1198` |
| `CROSS_MEM_LINK_NOT_ALLOWED` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1196`<br>`crates/memstead-mcp/src/filesystem_server.rs:459` |
| `CROSS_MEM_TARGET_MEM_UNCREATED` | engine | `crates/memstead-base/src/ops/mod.rs:1719` |
| `CROSS_MEM_TARGET_NOT_FOUND` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1197`<br>`crates/memstead-mcp/src/filesystem_server.rs:468` |
| `DERIVATION_BASELINE_REFRESHED` | engine | `crates/memstead-base/src/ops/mod.rs:1782` |
| `DESCRIPTION_NOT_PERMITTED` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1241`<br>`crates/memstead-base/src/ops/mod.rs:1795`<br>`crates/memstead-mcp/src/server.rs:1494` |
...
| `DUPLICATE_MEM` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1173`<br>`crates/memstead-mcp/src/server.rs:1599` |
...
| `EMBEDDED_SCHEMA_INVALID` | engine, CLI, MCP | `crates/memstead-base/src/engine/error.rs:1226`<br>`crates/memstead-cli/src/commands/install.rs:238`<br>`crates/memstead-mcp/src/server.rs:1383` |
| `EMPTY_UPDATE` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1201`<br>`crates/memstead-mcp/src/server.rs:1667` |
...
| `ENTITY_ALREADY_EXISTS` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1188`<br>`crates/memstead-mcp/src/server.rs:765` |
| `ENTITY_NOT_FOUND` | engine, CLI, MCP | `crates/memstead-base/src/engine/error.rs:1192`<br>`crates/memstead-cli/src/commands/context.rs:60`<br>`crates/memstead-cli/src/commands/delete.rs:55`<br>`crates/memstead-cli/src/commands/delete.rs:84`<br>`crates/memstead-cli/src/commands/delete.rs:127`<br>`crates/memstead-cli/src/commands/delete.rs:151`<br>`crates/memstead-cli/src/commands/entity.rs:58`<br>`crates/memstead-cli/src/commands/relations.rs:72`<br>`crates/memstead-cli/src/commands/rename.rs:139`<br>`crates/memstead-cli/src/commands/rename.rs:173`<br>`crates/memstead-cli/src/commands/update.rs:721`<br>`crates/memstead-cli/src/commands/update.rs:744`<br>`crates/memstead-mcp/src/filesystem_server.rs:370`<br>`crates/memstead-mcp/src/filesystem_server.rs:1044`<br>`crates/memstead-mcp/src/filesystem_server.rs:1877`<br>`crates/memstead-mcp/src/server.rs:755`<br>`crates/memstead-mcp/src/server.rs:1879`<br>`crates/memstead-mcp/src/server.rs:2446` |
...
| `HASH_MISMATCH` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1193`<br>`crates/memstead-mcp/src/server.rs:786` |
| `HAS_INCOMING_REFS` | engine | `crates/memstead-base/src/engine/error.rs:1194` |
...
| `INTERNAL` | CLI, MCP | `crates/memstead-cli/src/lib.rs:28`<br>`crates/memstead-mcp/src/filesystem_server.rs:1781`<br>`crates/memstead-mcp/src/filesystem_server.rs:1841` |
...
| `INVALID_CURSOR` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1237`<br>`crates/memstead-mcp/src/server.rs:1682` |
| `INVALID_DOMAIN` | CLI | `crates/memstead-cli/src/commands/domain.rs:148` |
| `INVALID_ENTITY_ID` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1211`<br>`crates/memstead-mcp/src/server.rs:310`<br>`crates/memstead-mcp/src/server.rs:325`<br>`crates/memstead-mcp/src/server.rs:1293` |
...
| `INVALID_TITLE` | engine, CLI, MCP | `crates/memstead-base/src/engine/error.rs:1187`<br>`crates/memstead-cli/src/commands/batch_create.rs:196`<br>`crates/memstead-cli/src/commands/create.rs:227`<br>`crates/memstead-mcp/src/server.rs:1260` |
| `INVALID_VERDICT` | CLI, MCP | `crates/memstead-cli/src/commands/check.rs:41`<br>`crates/memstead-mcp/src/server.rs:3215` |
| `INVALID_VERSION` | CLI | `crates/memstead-cli/src/commands/publish.rs:129` |
| `INVALID_WIKI_LINK_TARGET` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1212`<br>`crates/memstead-mcp/src/server.rs:1308` |
...
| `LOCAL_DIVERGENCE` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1178`<br>`crates/memstead-mcp/src/server.rs:883` |
| `LOCAL_INVALID_STATE` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1180`<br>`crates/memstead-mcp/src/server.rs:905` |
| `LOGIN_FAILED` | CLI | `crates/memstead-cli/src/commands/login.rs:40`<br>`crates/memstead-cli/src/commands/publish.rs:451` |
| `MARKDOWN_EXPORT_UNSUPPORTED_BACKEND` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1247`<br>`crates/memstead-mcp/src/server.rs:1654` |
| `MEM_CONFIG_INCOMPLETE` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1239`<br>`crates/memstead-mcp/src/server.rs:1465` |
| `MEM_ERROR` | engine, CLI, MCP | `crates/memstead-base/src/engine/error.rs:1224`<br>`crates/memstead-base/src/engine/error.rs:1229`<br>`crates/memstead-cli/src/commands/workspace.rs:767`<br>`crates/memstead-cli/src/commands/workspace.rs:774`<br>`crates/memstead-mcp/src/filesystem_server.rs:835`<br>`crates/memstead-mcp/src/server.rs:1417`<br>`crates/memstead-mcp/src/server.rs:1629` |
| `MEM_FILES_NOT_DELETED` | engine | `crates/memstead-base/src/ops/mod.rs:1786` |
| `MEM_HAS_INCOMING_REFS` | engine | `crates/memstead-base/src/engine/error.rs:1195` |
| `MEM_NAME_COLLISION` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1230`<br>`crates/memstead-mcp/src/server.rs:1366` |
...
| `MEM_QUARANTINED` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1175`<br>`crates/memstead-mcp/src/server.rs:818` |
| `MEM_REATTACHED_AFTER_UNREGISTER` | engine | `crates/memstead-base/src/ops/mod.rs:1787` |
| `MEM_REFERENCED_BY_POLICY` | MCP | `crates/memstead-mcp/src/server.rs:1784` |
...
| `MEM_SCHEMA_NOT_ALLOWED` | MCP | `crates/memstead-mcp/src/server.rs:1767` |
| `MEM_STORAGE_RESIDUE_DETECTED` | MCP | `crates/memstead-mcp/src/server.rs:1812` |
| `MISSING_REQUIRED_DESCRIPTION` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1240`<br>`crates/memstead-base/src/ops/mod.rs:1794`<br>`crates/memstead-mcp/src/server.rs:1511` |
| `MISSING_REQUIRED_FIELD` | engine | `crates/memstead-base/src/ops/mod.rs:1721` |
| `MISSING_REQUIRED_OUTGOING` | engine | `crates/memstead-base/src/engine/error.rs:1190`<br>`crates/memstead-base/src/ops/mod.rs:1772` |
| `MISSING_REQUIRED_SECTION` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1218`<br>`crates/memstead-base/src/ops/mod.rs:1720`<br>`crates/memstead-mcp/src/server.rs:1179` |
...
| `NON_FAST_FORWARD` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1179`<br>`crates/memstead-mcp/src/server.rs:892` |
...
| `NOT_CONFLICTED` | engine | `crates/memstead-base/src/engine/error.rs:1235` |
...
| `PARSE_ERROR` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1222`<br>`crates/memstead-base/src/engine/error.rs:1223`<br>`crates/memstead-mcp/src/filesystem_server.rs:837`<br>`crates/memstead-mcp/src/filesystem_server.rs:839`<br>`crates/memstead-mcp/src/server.rs:1611`<br>`crates/memstead-mcp/src/server.rs:1620` |
| `PATCH_OLD_NOT_FOUND` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1220`<br>`crates/memstead-mcp/src/server.rs:1216` |
| `PATCH_SECTION_EMPTY` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1219`<br>`crates/memstead-mcp/src/filesystem_server.rs:811`<br>`crates/memstead-mcp/src/server.rs:1203` |
...
| `PUSHED_COMMITS_PROTECTED` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1182`<br>`crates/memstead-mcp/src/server.rs:861` |
...
| `READ_ONLY_MOUNT` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1184`<br>`crates/memstead-mcp/src/server.rs:935` |
...
| `RELATIONSHIP_CYCLE` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1215`<br>`crates/memstead-mcp/src/server.rs:1103` |
| `RELATION_HAS_BODY_LINKS` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1206`<br>`crates/memstead-mcp/src/server.rs:1345` |
| `RELATION_MANUAL_AUTHORING_FORBIDDEN` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1243`<br>`crates/memstead-mcp/src/server.rs:1529` |
| `RENAME_BLOCKED_BY_CROSS_MEM_POLICY` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1203`<br>`crates/memstead-mcp/src/server.rs:1569` |
| `RENAME_NO_OP` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1200`<br>`crates/memstead-mcp/src/filesystem_server.rs:510`<br>`crates/memstead-mcp/src/server.rs:1543` |
| `RENAME_PARTIAL_FAILURE` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1205`<br>`crates/memstead-mcp/src/server.rs:1586` |
| `REPAIR_NOT_NEEDED` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1199`<br>`crates/memstead-mcp/src/server.rs:1076` |
| `REQUIRED_FIELD_UNSET` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1217`<br>`crates/memstead-mcp/src/server.rs:1145` |
| `RESIDUAL_STUB_FOR_READONLY_REFERRERS` | engine | `crates/memstead-base/src/ops/mod.rs:1785` |
| `REVIEW_MARK_NOT_SET` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1238`<br>`crates/memstead-mcp/src/server.rs:1693` |
...
| `SCHEMA_NOT_FOUND` | engine, CLI, MCP | `crates/memstead-base/src/engine/error.rs:1225`<br>`crates/memstead-cli/src/commands/schema.rs:838`<br>`crates/memstead-cli/src/commands/schema.rs:872`<br>`crates/memstead-cli/src/commands/schema.rs:888`<br>`crates/memstead-mcp/src/server.rs:1378` |
...
| `SCHEMA_RESOLVER_INIT_FAILED` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1228`<br>`crates/memstead-mcp/src/server.rs:1408` |
| `SCHEMA_UNSTAMPED_SOURCE_ROT` | engine | `crates/memstead-base/src/ops/mod.rs:1792` |
| `SCHEMA_VALIDATION_FAILED` | engine, CLI, MCP | `crates/memstead-base/src/engine/error.rs:1227`<br>`crates/memstead-cli/src/commands/schema.rs:589`<br>`crates/memstead-cli/src/commands/schema.rs:617`<br>`crates/memstead-cli/src/commands/schema.rs:642`<br>`crates/memstead-cli/src/commands/schema.rs:787`<br>`crates/memstead-cli/src/commands/schema.rs:799`<br>`crates/memstead-mcp/src/server.rs:1396` |
| `SCHEMA_VIOLATION_IN_FETCH` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1181`<br>`crates/memstead-mcp/src/server.rs:922` |
...
| `SEARCH_UNAVAILABLE_IN_WASM` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1245`<br>`crates/memstead-mcp/src/server.rs:1638` |
...
| `SET_AND_UNSET_CONFLICT` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1216`<br>`crates/memstead-mcp/src/server.rs:1194` |
| `SOURCE_UNREACHABLE` | CLI | `crates/memstead-cli/src/commands/projection.rs:1896` |
| `STUB_CANNOT_RELATE` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1208`<br>`crates/memstead-mcp/src/server.rs:1266` |
| `STUB_FILTER_EXCLUDES_ALL` | engine | `crates/memstead-base/src/ops/mod.rs:1730` |
| `STUB_NOT_RENAMABLE` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1210`<br>`crates/memstead-mcp/src/server.rs:1284` |
| `STUB_NOT_UPDATABLE` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1209`<br>`crates/memstead-mcp/src/server.rs:1275` |
...
| `UNKNOWN_ENTITY_TYPE` | engine, CLI, MCP | `crates/memstead-base/src/engine/error.rs:1186`<br>`crates/memstead-cli/src/commands/type_cmd.rs:54`<br>`crates/memstead-mcp/src/filesystem_server.rs:309`<br>`crates/memstead-mcp/src/server.rs:958`<br>`crates/memstead-mcp/src/server.rs:2532` |
...
| `UNKNOWN_REF` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1176`<br>`crates/memstead-mcp/src/server.rs:831` |
| `UNKNOWN_REMOTE` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1177`<br>`crates/memstead-mcp/src/server.rs:874` |
...
| `WIKILINK_WITHOUT_RELATION` | engine, MCP | `crates/memstead-base/src/engine/error.rs:1207`<br>`crates/memstead-mcp/src/server.rs:1478` |
