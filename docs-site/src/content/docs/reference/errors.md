...
| `SCHEMA_NOT_FOUND` | engine, CLI, MCP | `crates/memstead-base/src/engine/error.rs:1245`<br>`crates/memstead-cli/src/commands/schema.rs:867`<br>`crates/memstead-cli/src/commands/schema.rs:901`<br>`crates/memstead-cli/src/commands/schema.rs:917`<br>`crates/memstead-mcp/src/server.rs:1403` |
...
| `SCHEMA_VALIDATION_FAILED` | engine, CLI, MCP | `crates/memstead-base/src/engine/error.rs:1247`<br>`crates/memstead-cli/src/commands/schema.rs:618`<br>`crates/memstead-cli/src/commands/schema.rs:646`<br>`crates/memstead-cli/src/commands/schema.rs:671`<br>`crates/memstead-cli/src/commands/schema.rs:816`<br>`crates/memstead-cli/src/commands/schema.rs:828`<br>`crates/memstead-mcp/src/server.rs:1421` |
