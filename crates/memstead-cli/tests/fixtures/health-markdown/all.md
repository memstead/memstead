...
**Verdict coverage:** examined=dangling_links,config,mounts,missing_required_outgoing,constraints,signals,integrity; advisory=orphans,stubs,most_connected,missing_fields,stale,tags,labelling,conformance,anchors,friction,open_questions,vital_signs,stale_derivations,checks,ledger,due; not_examined=projection
