...
// The scope-enumeration cluster lives in the kernel (`crate::source_scope`)
...
#[cfg(test)]
pub(crate) use crate::source_scope::{allow_could_match_under, glob_literal_prefix};
pub(crate) use crate::source_scope::{
