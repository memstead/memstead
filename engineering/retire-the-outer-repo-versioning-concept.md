...
## Consequences
- The roster drops to seven here, and to six after the same-day plugin diet; plugin and marketplace bumped to 0.4.0; the skills reference regenerates to the shipped count.
...
- The engine's `outer_vcs` config field was left consumerless and dormant by this retirement, and the backlogged removal has since happened: no occurrence of the field survives anywhere under `public/` outside this entity's own text (verified 2026-08-30).
