...
- A schema declaring no format behaves byte-identically; the field-evidence proof holds — one field project's two-halves citation grammar and the other's coordinate grammar are declared without project Python.
