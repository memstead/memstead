...
#
# This wrapper fetches and runs both in sequence. The plan AC names
# a single `curl -sSf <url> | sh` install path; this file is the
# operator-side bridge that delivers it.
#
# Operator-side setup:
